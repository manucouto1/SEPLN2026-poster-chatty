...
\headerbox{}{name=results,span=1,column=2,below=modelroles,
  ...
  \begin{tcolorbox}[infocard, title={6. Results}]
    ...
    \begin{tcolorbox}[resultcard, title={Q1 -- Alignment with medical consensus}]
      \centering
      \includegraphics[width=0.86\linewidth]{figures/chart_q1.pdf}
    \end{tcolorbox}
    \vspace{0.35em}
    \begin{tcolorbox}[resultcard, title={Q3 -- Relevance \& factuality}]
      \centering
      \includegraphics[width=0.86\linewidth]{figures/chart_q3.pdf}
    \end{tcolorbox}
    \vspace{0.35em}
    \begin{tcolorbox}[resultcard, title={Key observations}]
      \small \raggedright
      \begin{itemize}\itemsep6pt \parskip0pt \parsep0pt \leftskip-0.4cm
...
\headerbox{}{name=qr,span=1,column=0,below=casestudy,
  ...
  \begin{tcolorbox}[infocard, title={Try it \& Resources}]
    ...
    \begin{minipage}[c]{0.49\linewidth}
      \centering
      \includegraphics[width=0.62\linewidth]{figures/qr_github.png}\\[3pt]
      {\small Code \& quick start}
    \end{minipage}\hfill
    \begin{minipage}[c]{0.49\linewidth}
      \centering
      \includegraphics[width=0.62\linewidth]{figures/qr_video.png}\\[3pt]
      {\small Video demo}
    \end{minipage}
  \end{tcolorbox}
}
...
\headerbox{}{name=footer,span=1,column=0,below=qr,
  ...
  \vspace{-0.7cm}
  \begin{center}
    \includegraphics[width=0.66\linewidth]{figures/sepln2026_logo.png}
  \end{center}
}
...
\headerbox{}{name=conclusions,span=1,column=1,below=casestudy,
  ...
  \begin{tcolorbox}[infocard, title={7. Key Findings \& Conclusions}]
    \small
    \begin{itemize}\itemsep8pt \parskip0pt \parsep0pt \leftskip-0.4cm
