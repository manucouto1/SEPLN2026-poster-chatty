...
% Referencia: -0.20em holgado, -0.35em pegado, -0.50em el pico toca la C.
\newcommand{\ParrotGap}{-0.35em}
\newcommand{\parrotemoji}{\raisebox{-0.2em}{\reflectbox{\includegraphics[height=1.15em]{figures/parrot.pdf}}}}
...
% -------------------- CENTRO (Título + Autores) --------------------
{
  \makebox[\linewidth][l]{%
    ...
    \parbox{1.0\linewidth}{\raggedright
      {\TitleLineA \parrotemoji\hspace{\ParrotGap} Chatty:}\\[0.2em]
