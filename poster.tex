...
% Desplazamiento del grupo loro+"Chatty:" respecto al margen izquierdo. Se aplica
% solo a la primera línea del título, así que loro y letras se mueven juntos y
% conservan su posición relativa. 1em aqui son ~2.5 cm en el A0 impreso.
\newcommand{\TitleShift}{0.35em}
\newcommand{\ParrotGap}{-0.30em}
\newcommand{\parrotemoji}{\raisebox{-0.1em}{\reflectbox{\includegraphics[height=0.95em]{figures/parrot.pdf}}}}
...
% -------------------- CENTRO (Título + Autores) --------------------
{
  \makebox[\linewidth][l]{%
    ...
    \parbox{1.0\linewidth}{\raggedright
      {\TitleLineA \hspace*{\TitleShift}\ChattyTitle}\\[0.2em]
